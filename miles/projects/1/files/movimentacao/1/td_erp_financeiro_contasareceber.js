// JS da Movimentação// Invocado ao clicar no botão Novo
function beforeNew(){
}
...
setTimeout( () => {
    $("#pago","#form-movimentacao").parent().find(".checkbox-s").click();
    $("#datarecebimento","#form-movimentacao").val(config.datahora.split(" ")[0]);
},1000);