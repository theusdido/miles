...
function criarEntidade(
	...
	if ($criarempresa == 1){
		criarAtributo($conn,$entidade,'empresa','Empresa','smallint',0,1,'16',0,installDependencia($conn,"empresa","system/"),0,'session.empresa',1);
	}
	if ($criarauth == 1){
...
function getDataType($atributo,$entidade = "",$conn = null){
	...
	return tdClass::Criar("persistent",array(ATRIBUTO,$atributo))->contexto->tipo;
}
