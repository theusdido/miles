<?php
	...
	$strutuct = json_decode(file_get_contents(FOLDER_CORE . '/' .  FOLDER_CONFIG . '/' . "estrutura.json"));

	// Inclui a classe AutoLoad
	require $strutuct->auto_load_class;
	...
	if (!Transacao::abrir("current") && (tdc::r('controller') == '' || tdc::r('controller') == 'install') ){

		// Redireciona o sistema para instalação do sistema
		include 'core/controller/install.php';
		exit;
	}
