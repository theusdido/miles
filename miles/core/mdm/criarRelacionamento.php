	...
	<head>
		...
		<script type="text/javascript">
			...
			function disableAtributo(tipo){
				...
				if (tipo == 5 || tipo == 3 || tipo == 10 || tipo == 1 || tipo == 7){
					$("#atributo").val(0);
			...
			function carregarAtributos(){
				console.log("dados => " + entidadecarregar);
						...
						<fieldset>
							...
							<div class="form-group">
								...
								<select name="tipo" id="tipo" class="form-control">
									<option value="1">Associa&ccedil;&atilde;o - Agrega&ccedil;&atilde;o (1:1)</option>
									<option value="6">Associa&ccedil;&atilde;o - Agrega&ccedil;&atilde;o (1:N)</option>
									<option value="5">Associa&ccedil;&atilde;o - Agrega&ccedil;&atilde;o (N:N)</option>
									<option value="7">Associa&ccedil;&atilde;o - Composi&ccedil;&atilde;o (1:1)</option>
									<option value="2">Associa&ccedil;&atilde;o - Composi&ccedil;&atilde;o (1:N)</option>
									<option value="10">Associa&ccedil;&atilde;o - Composi&ccedil;&atilde;o (N:N)</option>
									<option value="3">Generaliza&ccedil;&atilde;o/Especializa&ccedil;&atilde;o (1:1)</option>
									<option value="8">Generaliza&ccedil;&atilde;o/Especializa&ccedil;&atilde;o (1:N)</option>
									<option value="9">Generaliza&ccedil;&atilde;o/Especializa&ccedil;&atilde;o M&uacute;ltipla (1:1)</option>
									<option value="4">Depend&ecirc;ncia</option>
								</select>
							</div>
							<div class="form-group">
