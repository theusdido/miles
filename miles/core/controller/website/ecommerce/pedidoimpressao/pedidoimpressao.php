...
$style		= tdc::o("link");
$style->href= PATH_CURRENT_FILES_ECOMMERCE . "pedidoimpressao/pedidoimpressao.css";
...
// Status do pedido
$statusPedido = tdc::p("td_ecommerce_statuspedido",$pedido->td_status)->descricao;
...
$divcabecalhopedido = $topo->add("div", array("propriedades" => array( "class" => "div-cabecalho-pedido" , "innerhtml" => array(
	$topo->node("div", array("innerhtml" => "Status: " .  $statusPedido, "class" => "div-cabecalho-pedido-status")),
    $topo->node("div", array("innerhtml" => "Valor Frete: R$ " . moneyToFloat($valorFrete,true) , "class" => "div-cabecalho-pedido-valorfrete")),
	$topo->node("div", array("innerhtml" => "Valor Total: R$ " . moneyToFloat($pedido->getValorTotal(),true) , "class" => "div-cabecalho-pedido-valortotal"))
))));
...
foreach($pedido->getItens() as $item){
	...
	$tdProduto 	= $tabela->add("td",array("propriedades" => array( "innerhtml" => $item['descricao'] ) , "elementopai" => $trBody));
	$tdTamanho 	= $tabela->add("td",array("propriedades" => array( "innerhtml" => $item['tamanho'] ) , "elementopai" => $trBody));
