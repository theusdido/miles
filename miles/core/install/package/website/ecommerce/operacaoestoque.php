<?php
	...
	$operacaoestoque = criarAtributo($conn,$entidadeID,"operacaoestoque","Operação","int",0,0,4,1,installDependencia($conn,"ecommerce_tipooperacaoestoque","package/website/"));
	
	// Criando Acesso
	$menu_webiste = addMenu($conn,'Material','#','','','','material');

	// Adicionando Menu
	addMenu($conn,$entidadeDescricao,"files/cadastro/".$entidadeID."/".PREFIXO.$entidadeNome.".html",'',$menu_webiste,8,'material-' . $entidadeNome);