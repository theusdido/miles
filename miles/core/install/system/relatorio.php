<?php
	...
	// Criando Atributos
	$relatorio = criarAtributo($conn,$filtrosID,"td_relatorio","Relatório","int",0,0,4,0,0,0,"");
	...
	$relatorio = criarAtributo($conn,$statusGradeID,"td_relatorio","Relatório","int",0,0,4,0,0,0,"");
