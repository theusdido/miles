...
function versubmenu(id,descricao){
    ...
    $('#menu-pai-descricao').html(descricao);
    listar();
}
...
function goForm(){
    loadPage('mdm/configuracoes/menu/topo/form','#mdm-conteudo');
}
function criar(){
    goForm();
}
...
function listar(){
    $('#tmenutopo tbody').load(session.urlmiles + '?controller=mdm/menu/topo&op=listar&pai=' + _menutopo_pai);
}