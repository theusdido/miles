<?php
	...
	$tiposervico 	= criarAtributo($conn,$entidadeID,"tipo","Tipo","int",0,1,4,0,installDependencia("erp_servico_tiposervico",'package/sistema/erp/servico/tiposervico'));
