<?php
	...
	$autor       		= criarAtributo($conn,$entidadeID,"autor","Autor","int",0,1,22,0,installDependencia($conn,"erp_livraria_autor"));
	$titulo 			= criarAtributo($conn,$entidadeID,"titulo","Título","varchar",200,0,3,1);
	$editora       		= criarAtributo($conn,$entidadeID,"editora","Editora","int",0,1,22,0,installDependencia($conn,"erp_livraria_editora"));
	...
	$genero       		= criarAtributo($conn,$entidadeID,"genero","Gênero","int",0,1,4,0,installDependencia($conn,"erp_livraria_genero"));
