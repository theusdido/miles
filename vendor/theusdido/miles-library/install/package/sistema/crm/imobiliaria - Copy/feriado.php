<?php
	// Setando variáveis
	$entidadeNome = "erp_imobiliaria_feriados";
	$entidadeDescricao = "Feriados";
	// Criando Entidade
	...
	$descricaoferiado = criarAtributo($conn,$entidadeID,"descricaoferiado","Descrição do Feriado","varchar",200,0,3);
	// Criando Acesso
