<?php
	...
	$agencia 	= criarAtributo($conn,$entidadeID,"agencia","Agência","varchar",30,0,3);
	$divagencia = criarAtributo($conn,$entidadeID,"divagencia","DV Agência","varchar",3,1,3);
	$operacao 	= criarAtributo($conn,$entidadeID,"operacao","Operação","int",0,1,4,0,installDependencia("erp_financeiro_operacaobancaria",'package/sistema/erp/financeiro/operacaobancaria'),0,"",0,0);
	$numero 	= criarAtributo($conn,$entidadeID,"numero","Número","varchar",60,0,25);
	$divconta 	= criarAtributo($conn,$entidadeID,"divconta","DV Conta","varchar",3,1,3);
