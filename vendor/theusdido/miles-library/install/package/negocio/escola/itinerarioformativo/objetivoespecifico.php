<?php
	...
	// Setando variáveis
	$entidadeNome 			= "erp_escola_objetivoespecifico";
	$entidadeDescricao 		= "Objetivos Específicos";
	...
	// Criando Acesso
	$menu = addMenu($conn,'Itinerário Formativo','#','',0,0,'escola-itinerarioformativo');
	...
	// Relacionamento
	criarRelacionamento($conn,6,getEntidadeId("erp_escola_unidadecurricular"),$entidadeID,"Objetivo Específico",$unidadecurricular);