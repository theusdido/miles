<?php
	...
	// Atributos
	$filial 					= criarAtributo($conn,$entidadeID,"filial","Filial","int",0,1,4,0,installDependencia('empresa','system/'),0,"",1,0);
	$empreendimento 			= criarAtributo($conn,$entidadeID,"empreendimento","Empreendimento","int",0,1,4,0,installDependencia('imobiliaria_empreendimento','package/negocio/imobiliaria/imovel/empreendimento'),0,"",1,0);
	$administradoracondominio 	= criarAtributo($conn,$entidadeID,"administradoracondominio","Administradora Condominio","int",0,1,4,0,installDependencia('imobiliaria_administradoracondominio','package/negocio/imobiliaria/condominio/administradoracondominio'),0,"",1,0);		
	...
	$iptuAba 					= installDependencia("imobiliaria_iptu",'package/negocio/imobiliaria/imovel/iptu');
	$unidadeAba 				= installDependencia("imobiliaria_unidadeimovel",'package/negocio/imobiliaria/imovel/unidadeimovel');
	$proprietariosAba 			= installDependencia("imobiliaria_imovelproprietario",'package/negocio/imobiliaria/imovel/imovelproprietario');
	$enderecosAba 				= installDependencia("imobiliaria_imovelendereco",'package/negocio/imobiliaria/imovel/imovelendereco');
	$fotoAba 					= installDependencia("imobiliaria_imovelfoto",'package/negocio/imobiliaria/imovel/imovelfoto');		