<?php
	...
	// Criando Atributos	
	$unidadesimovel = criarAtributo($conn,$entidadeID,"unidadesimovel","Unidades Imóvel","int",0,0,4,1,installDependencia('imobiliaria_unidadesimovel','package/negocio/imobiliaria/unidadesimovel'),0,"",1,0);
