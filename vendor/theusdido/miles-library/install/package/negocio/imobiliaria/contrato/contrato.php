<?php
	...
	// Setando variáveis
	$entidadeNome 		= "imobiliaria_contrato";
	...
	// Criando Atributos
	$origem 					= criarAtributo($conn,$entidadeID,"origemfilial","Origem do Cadastro ( Filial )","int",0,0,4,0,installDependencia("imobiliaria_empresas",'package/negocio/imobiliaria/geral/empresas'));
	$agenciamento 				= criarAtributo($conn,$entidadeID,"agenciamento","Agenciamento","int",0,1,16);
	$atendente 					= criarAtributo($conn,$entidadeID,"atendente","Atendente","int",0,0,4,0,installDependencia("imobiliaria_atendente",'package/negocio/imobiliaria/crm/atendente'),0,'',1,1);
	$periocidade 				= criarAtributo($conn,$entidadeID,"periocidade","Periocidade","int",0,0,4,0,installDependencia("imobiliaria_periodicidade",'package/negocio/imobiliaria/geral/periodicidade'),0,'',1,0);
	...
	$imovel 					= criarAtributo($conn,$entidadeID,"imovel","Imóvel","int",0,0,22,0,installDependencia("imobiliaria_imovel",'package/negocio/imobiliaria/imovel/imovel'),0,'',1,0);
	$categoriaimovel 			= criarAtributo($conn,$entidadeID,"categoriaimovel","Categoria do Imóvel","int",0,0,4,0,installDependencia("imobiliaria_categoriaimovel",'package/negocio/imobiliaria/imovel/categoriaimovel'));
	$modalidadegarantia 		= criarAtributo($conn,$entidadeID,"modalidadegarantia","Modalidade Garantia","int",0,0,4,0,installDependencia("imobiliaria_modalidadegarantia",'package/negocio/imobiliaria/contrato/modalidadegarantia'));
	...
	$formapagamento 			= criarAtributo($conn,$entidadeID,"formapagamento","Forma de Pagamento","int",0,0,4,0,installDependencia("imobiliaria_formapagamento",'package/negocio/imobiliaria/financeiro/formapagamento'));
	...
	$bancoboleto 				= criarAtributo($conn,$entidadeID,"bancoboleto","Banco Boleto","int",0,0,4,0,installDependencia("imobiliaria_banco",'package/negocio/imobiliaria/financeiro/banco'));
	...
	$entidadeIDInquilinocontrato 	= criarEntidade($conn,"imobiliaria_contratoinquilino","Inquilinos do Contrato",1,0,0,0,0,0,1,1,0,0);
	$inquilino 					 	= criarAtributo($conn,$entidadeIDInquilinocontrato,"inquilino","Inquilino","int",0,0,22,1,installDependencia("imobiliaria_pessoa",'package/negocio/imobiliaria/pessoa/pessoa'));
	...
	$entidadeIDFiadorcontrato 	= criarEntidade($conn,"imobiliaria_contratofiador","Fiadores do Contrato",1,0,0,0,0,0,1,1,0,0);
	$fiador 					= criarAtributo($conn,$entidadeIDFiadorcontrato,"fiador","Fiador","int",0,0,22,1,installDependencia("imobiliaria_pessoa",'package/negocio/imobiliaria/pessoa/pessoa'));
	...
	$entidadeIDProprietariocontrato 	= criarEntidade($conn,"imobiliaria_contratoproprietario","Proprietarios do Contrato",1,0,0,0,0,0,1,1,0,0);
	$proprietario 						= criarAtributo($conn,$entidadeIDProprietariocontrato,"proprietario","Proprietário","int",0,0,22,1,installDependencia("imobiliaria_pessoa",'package/negocio/imobiliaria/pessoa/pessoa'));
	...
	$entidadeIDDescontocontrato 	= criarEntidade($conn,"imobiliaria_descontocontrato","Desconto",1,0,0,0,0,0,1,1,0,0);
	...
	$entidadeIDParagrafoClausulacontrato = criarEntidade(
		$conn,
		"imobiliaria_paragrafoclausulacontrato",
	...
	// Criando Acesso
	$menu = addMenu($conn,'Contrato','#','',0,0,'contrato');
