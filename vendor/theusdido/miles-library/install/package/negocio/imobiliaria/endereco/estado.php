<?php
	// Setando variáveis
	$entidadeNome 		= "imobiliaria_estado";
	$entidadeDescricao 	= "Estado";
	...
	$pais 			= criarAtributo($conn,$entidadeID,"pais","País","Int",0,0,4,0,installDependencia('imobiliaria_pais','package/negocio/imobiliaria/endereco/pais'));
