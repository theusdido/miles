<?php
	...
	$sila 		= criarAtributo($conn,$entidadeID,"sigla","Sigla","char",3,1,1);
	$estado 	= criarAtributo($conn,$entidadeID,"estado","Estado","Int",0,0,4,0,installDependencia('imobiliaria_estado','package/negocio/imobiliaria/endereco/estado'));
