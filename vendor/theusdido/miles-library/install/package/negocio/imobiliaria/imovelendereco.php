<?php
	...
	$tipoendereco 		= criarAtributo($conn,$entidadeID,"tipoendereco","Tipo de Endereço","int",0,0,4,0,installDependencia('imobiliaria_tipoendereco','package/negocio/imobiliaria/tipoendereco'),0,"",1,0);
	...
	$endereco 			= criarAtributo($conn,$entidadeID,"endereco","Endereço","int",0,0,24,0,installDependencia('imobiliaria_endereco','package/negocio/imobiliaria/endereco'),0,"",1,0);
