<?php	
	$entidadeNome 		= "website_geral_rodape";
	...
	// 4º PASSO
	addMenu($conn,$entidadeDescricao,"files/cadastro/".$entidadeID."/".getSystemPREFIXO().$entidadeNome.".html",'',$menu_webiste,9,'website-'.$entidadeNome,$entidadeID,'cadastro');