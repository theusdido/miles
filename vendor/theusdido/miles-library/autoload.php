...
');
	...
	// Setar o ambiente do arquivo .htaccess como prioridade,
	// caso contrario, setar o arquivo o ambiente pelo arquivo miles.json
	if (!empty($_env_params)){
		$_current_environment 	= $_env_params;
	}else if (isset($_miles_config_root->environment)){
