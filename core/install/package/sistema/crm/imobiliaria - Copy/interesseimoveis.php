<?php
	// Setando variáveis
	$entidadeNome = "crm_imobiliaria_interesseimoveis";
	...
	// Criando Atributos
	$imoveis = criarAtributo($conn,$entidadeID,"imovel","Imóvel","int",0,0,4,0,installDependencia($conn,"crm_imobiliaria_imovel"));
