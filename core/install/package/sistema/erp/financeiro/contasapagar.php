<?php
	...
	$fornecedor 	= criarAtributo($conn,$entidadeID,"fornecedor","Fornecedor","int",0,1,22,1,installDependencia($conn,"erp_geral_pessoa"));
	...
	$formapagamento = criarAtributo($conn,$entidadeID,"formapagamento","Forma de Pagamento","int",0,1,4,0,installDependencia($conn,"erp_financeiro_formapagamento"));
	...
	$despesa 		= criarAtributo($conn,$entidadeID,"despesa","Despesa","int",0,1,4,0,installDependencia($conn,"erp_financeiro_despesa"));
