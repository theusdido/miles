<?php
	...
	$categoria 			= criarAtributo($conn,$entidadeID,"categoria","Categoria","int",0,1,4,0,installDependencia("erp_comercial_categoriaproduto",'package/sistema/erp/produto/categoriaproduto'),0,"",1,0);
	$marca 				= criarAtributo($conn,$entidadeID,"marca","Marca","int",0,1,4,22,installDependencia("erp_produto_marca",'package/sistema/erp/produto/marca'),0,'',1,0);
	$unidademedida 		= criarAtributo($conn,$entidadeID,"unidademedida","Unidade de Medida","int",0,1,22,0,installDependencia("erp_produto_unidademedida",'package/sistema/erp/produto/unidademedida'));	
