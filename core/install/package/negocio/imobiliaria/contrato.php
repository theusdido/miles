<?php
	...
	// Criando Atributos
	$origem 					= criarAtributo($conn,$entidadeID,"origemfilial","Origem do Cadastro ( Filial )","int",0,0,4,0,installDependencia("imobiliaria_empresas",'package/negocio/imobiliaria/empresas'));
	$agenciamento 				= criarAtributo($conn,$entidadeID,"agenciamento","Agenciamento","int",0,1,16);
	$atendente 					= criarAtributo($conn,$entidadeID,"atendente","Atendente","int",0,0,4,0,installDependencia("imobiliaria_atendente",'package/negocio/imobiliaria/atendente'),0,'',1,1);
	$periocidade 				= criarAtributo($conn,$entidadeID,"periocidade","Periocidade","int",0,0,4,0,installDependencia("imobiliaria_periodicidade",'package/negocio/imobiliaria/periodicidade'),0,'',1,0);
	...
	$imovel 					= criarAtributo($conn,$entidadeID,"imovel","Imóvel","int",0,0,22,0,installDependencia("imobiliaria_imovel",'package/negocio/imobiliaria/imovel'),0,'',1,0);
	$categoriaimovel 			= criarAtributo($conn,$entidadeID,"categoriaimovel","Categoria do Imóvel","int",0,0,4,0,installDependencia("imobiliaria_categoriaimovel",'package/negocio/imobiliaria/categoriaimovel'));
	$modalidadegarantia 		= criarAtributo($conn,$entidadeID,"modalidadegarantia","Modalidade Garantia","int",0,0,4,0,installDependencia("imobiliaria_modalidadegarantia",'package/negocio/imobiliaria/modalidadegarantia'));
	...
	$formapagamento 			= criarAtributo($conn,$entidadeID,"formapagamento","Forma de Pagamento","int",0,0,4,0,installDependencia("imobiliaria_formapagamento",'package/negocio/imobiliaria/formapagamento'));
	...
	$bancoboleto 				= criarAtributo($conn,$entidadeID,"bancoboleto","Banco Boleto","int",0,0,4,0,installDependencia("imobiliaria_banco",'package/negocio/imobiliaria/banco'));
	...
	$inquilino 					 	= criarAtributo($conn,$entidadeIDInquilinocontrato,"inquilino","Inquilino","int",0,0,22,1,installDependencia("imobiliaria_pessoa",'package/negocio/imobiliaria/pessoa'));
	...
	$fiador 					= criarAtributo($conn,$entidadeIDFiadorcontrato,"fiador","Fiador","int",0,0,22,1,installDependencia("imobiliaria_pessoa",'package/negocio/imobiliaria/pessoa'));
	...
	$proprietario 						= criarAtributo($conn,$entidadeIDProprietariocontrato,"proprietario","Proprietário","int",0,0,22,1,installDependencia("imobiliaria_pessoa",'package/negocio/imobiliaria/pessoa'));
