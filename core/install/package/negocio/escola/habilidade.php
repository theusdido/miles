<?php
	...
	// Setando variáveis
	$entidadeNome = "erp_escola_habilidade";
	$entidadeDescricao = "Habilidade";
	...
	// Relacionamento
	criarRelacionamento($conn,6,getEntidadeId("erp_escola_unidadecurricular"),$entidadeID,"Habilidade",$unidadecurricular);