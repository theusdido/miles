<?php
	...
	// Setando variáveis
	$entidadeNome = "erp_escola_conteudo";
	$entidadeDescricao = "Conteúdo";
	...
	// Relacionamento
	criarRelacionamento($conn,6,getEntidadeId("erp_escola_unidadecurricular"),$entidadeID,"Conteúdo",$unidadecurricular);