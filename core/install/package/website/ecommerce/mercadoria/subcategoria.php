<?php
    ...
    $modalidade = criarAtributo($conn, $entidadeID,"modalidade","Modalidade","int",0,0,4,1,installDependencia("ecommerce_modalidade","package/website/ecommerce/geral/modalidade"));
