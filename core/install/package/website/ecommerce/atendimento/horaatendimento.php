<?php
    ...
    $dia 			= criarAtributo($conn, $entidadeID,"diasemana","Dia","int",0,0,4,1,installDependencia($conn,"diasemana","geral/diasemana"));
	...
	$observacao		= criarAtributo($conn, $entidadeID,"observacao","Observaчуo","varchar",50,1,3);
