...
// Status do pedido
$statusPedido = utf8charset ( tdc::p("td_ecommerce_statuspedido",$pedido->status)->descricao , 5);
...
$tdTotalLabel	= $tabela->add("td",array("propriedades" => array( "innerhtml" => "TOTAL" , "colspan" => "4") , "elementopai" => $trBody));
