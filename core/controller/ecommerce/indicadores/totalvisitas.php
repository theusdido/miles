...
$titulo		= $topo->add("h1",array(
    "propriedades" => array("innerhtml" => "TOTAL DE VISITAS" , "id" => "titulo"),
...
$thSessao 	    = $tabela->add("th",array("propriedades" => array( "innerhtml" => utf8_encode("Sess�o") , "align" => "left" , "width" => "15%" ) , "elementopai" => $trHead));
...
foreach($itens as $item){
    ...
    if ($item->cliente == 0){
        $cliente = utf8_encode("N�o Logado");
    }else{
