...
$divcabecalhopedido = $topo->add("div", array("propriedades" => array("style" => "width:100%;float:left;margin:15px 0;", "innerhtml" => array(
	$topo->node("div", array("innerhtml" => "Status............: " . tdc::p("td_ecommerce_statuspedido",$pedido->status)->descricao,				"style" => "width:100%;font-weight: bold;float:left;margin-top:10px;")),
