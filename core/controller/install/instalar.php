<?php
    ...
    switch($op){
        ...
        case 'inserirregistros':
			...
			// Menu
			inserirRegistro($conn,MENU,1, array("descricao","link","target","pai","ordem","fixo","entidade","tipomenu"), array("'Administração'","'#'","''",0,1,"'adm'",0,1));
			$usuarioID = getEntidadeId("usuario",$conn);
			inserirRegistro($conn,MENU,2, array("descricao","link","target","pai","ordem","fixo","entidade","tipomenu"), array("'Usuário'","'files/cadastro/".$usuarioID."/".getSystemPREFIXO()."usuario.html'","''",1,1,"''",$usuarioID,1));
			$menuID = getEntidadeId("menu",$conn);
			inserirRegistro($conn,MENU,3, array("descricao","link","target","pai","ordem","fixo","entidade","tipomenu"), array("'Menu'","'files/cadastro/".$menuID."/".getSystemPREFIXO()."menu.html'","''",1,2,"''",$menuID,1));
			$projetoID = getEntidadeId("projeto",$conn);
			inserirRegistro($conn,MENU,4, array("descricao","link","target","pai","ordem","fixo","entidade","tipomenu"), array("'Projeto'","'files/cadastro/".$projetoID."/".getSystemPREFIXO()."projeto.html'","''",1,3,"''",$projetoID,1));
			$empresaID = getEntidadeId("empresa",$conn);
			inserirRegistro($conn,MENU,5, array("descricao","link","target","pai","ordem","fixo","entidade","tipomenu"), array("'Empresa'","'files/cadastro/".$empresaID."/".getSystemPREFIXO()."empresa.html'","''",1,4,"''",$empresaID,1));
			$avisoID = getEntidadeId("aviso",$conn);
			inserirRegistro($conn,MENU,6, array("descricao","link","target","pai","ordem","fixo","entidade","tipomenu"), array("'Aviso'","'files/cadastro/".$avisoID."/".getSystemPREFIXO()."aviso.html'","''",1,5,"''",$avisoID,1));
			$grupousuarioID = getEntidadeId("grupousuario",$conn);
			inserirRegistro($conn,MENU,7, array("descricao","link","target","pai","ordem","fixo","entidade","tipomenu"), array("'Grupo de Usuário'","'files/cadastro/".$grupousuarioID."/".getSystemPREFIXO()."grupousuario.html'","''",1,6,"''",$grupousuarioID,1));
			
			inserirRegistro($conn,MENU,8, array("descricao","link","target","pai","ordem","fixo","entidade","tipomenu"), array("'Ticket'","'#'","''",0,2,"'ticket'",0,1));
			$ticketstatusID = getEntidadeId("ticketstatus",$conn);
			inserirRegistro($conn,MENU,9, array("descricao","link","target","pai","ordem","fixo","entidade","tipomenu"), array("'Status'","'files/cadastro/".$ticketstatusID."/".getSystemPREFIXO()."ticketstatus.html'","''",8,1,"''",$ticketstatusID,1));
			$ticketprioridadeID = getEntidadeId("ticketprioridade",$conn);
			inserirRegistro($conn,MENU,10, array("descricao","link","target","pai","ordem","fixo","entidade","tipomenu"), array("'Prioridade'","'files/cadastro/".$ticketprioridadeID."/".getSystemPREFIXO()."ticketprioridade.html'","''",8,2,"''",$ticketprioridadeID,1));
			$tickettipoID = getEntidadeId("tickettipo",$conn);
			inserirRegistro($conn,MENU,11, array("descricao","link","target","pai","ordem","fixo","entidade","tipomenu"), array("'Tipo'","'files/cadastro/".$tickettipoID."/".getSystemPREFIXO()."tickettipo.html'","''",8,3,"''",$tickettipoID,1));
			$ticketID = getEntidadeId("ticket",$conn);
			inserirRegistro($conn,MENU,12, array("descricao","link","target","pai","ordem","fixo","entidade","tipomenu"), array("'Ticket'","'files/cadastro/".$ticketID."/".getSystemPREFIXO()."ticket.html'","''",8,4,"''",$ticketID,1));
			$ticketinteractionID = getEntidadeId("ticketinteraction",$conn);
			inserirRegistro($conn,MENU,13, array("descricao","link","target","pai","ordem","fixo","entidade","tipomenu"), array("'Ticket Interação'","'files/cadastro/".$ticketinteractionID."/".getSystemPREFIXO()."ticketinteraction.html'","''",8,5,"''",$ticketinteractionID,1));
			$ticketseguidoresID = getEntidadeId("ticketseguidores",$conn);
			inserirRegistro($conn,MENU,14, array("descricao","link","target","pai","ordem","fixo","entidade","tipomenu"), array("'Seguidores'","'files/cadastro/".$ticketseguidoresID."/".getSystemPREFIXO()."ticketseguidores.html'","''",8,6,"''",$ticketseguidoresID,1));
