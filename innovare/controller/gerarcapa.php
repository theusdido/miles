...
error_reporting(E_ALL);	
	...
	$credor = tdClass::Criar("persistent",array("td_relacaocredores",$protocolo->td_credor))->contexto;
	$processo = tdClass::Criar("persistent",array("td_processo",$protocolo->td_processo))->contexto;
